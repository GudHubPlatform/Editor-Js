export default class ProsCons {
    ...
    render() {
        ...
        let addButtonWrapperPros;
        let addButtonWrapperCons;
        let addButtonPros;
        let addButtonCons;
        // if ( !this.readOnly ) {
            addButtonWrapperPros = document.createElement('div');
            addButtonWrapperPros.classList.add('addButtonWrapperPros');
            addButtonPros = document.createElement('div');
            addButtonPros.classList.add('addButtonPros');
            addButtonPros.textContent = '+';
            addButtonWrapperPros.appendChild(addButtonPros)

            addButtonWrapperCons = document.createElement('div');
            addButtonWrapperCons.classList.add('addButtonWrapperCons');
            addButtonCons = document.createElement('div');
        ...
        product.setAttribute('contenteditable', this.readOnly ? "false" : "true");
        ...
        author.setAttribute('contenteditable', this.readOnly ? "false" : "true");
        ...
        if ( this.data.pros_list ){
            for(let p = 0; p < this.data.pros_list.length; p++){
                ...
                <div contenteditable="${this.readOnly ? "false" : "true"}">+</div>
                <div contenteditable="${this.readOnly ? "false" : "true"}" class="pros_value">${input_pros_data}</div>
                `;
        ...
        if ( this.data.cons_list ){
            ...
            consFlex.innerHTML = /*html*/ `
               <div contenteditable="${this.readOnly ? "false" : "true"}">-</div>
               <div contenteditable="${this.readOnly ? "false" : "true"}" class="cons_value">${input_cons_data}</div>
            `;
        ...
        if ( this.readOnly ) {
            productCheck.setAttribute('disabled', 'true');
            authorCheck.setAttribute('disabled', 'true');
        }
